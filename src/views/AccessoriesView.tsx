      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-3">
            <span className="text-[11px] uppercase tracking-[0.2em] text-[#8E929E] font-semibold">
          ...
          <div className="flex items-center gap-2 overflow-x-auto pb-3 scrollbar-thin scrollbar-thumb-[#262930] scrollbar-track-transparent">
            ...
            <button
              type="button"
              onClick={() => handleSelectSubcategory('All')}
              className={`px-4 py-2.5 rounded-xl text-xs uppercase tracking-wider font-semibold transition-all flex items-center gap-2 flex-shrink-0 ${
                selectedSubcategory === 'All'
            ...
            <div className="relative flex-1 max-w-md">
              ...
              {searchQuery && (
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-[#8E929E] hover:text-white"
                >
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              {(selectedSubcategory !== 'All' || searchQuery || maxPrice < 50000) && (
                <button
                  ...
                  className="py-2 px-3 rounded-xl bg-[#181A1F] hover:bg-[#20232A] text-xs text-[#D4AF37] border border-[#262930] transition-colors"
                >
                  Reset
                </button>
              )}
          ...
          <div className="py-24 text-center rounded-3xl bg-[#121316] border border-[#262930] p-8 space-y-4 max-w-2xl mx-auto">
            ...
            <div className="pt-2">
              <button
                type="button"
                onClick={handleResetFilters}
                className="py-3 px-6 rounded-xl bg-[#D4AF37] hover:bg-[#E5C378] text-[#0B0C0E] text-xs font-bold uppercase tracking-wider transition-colors"
              >
