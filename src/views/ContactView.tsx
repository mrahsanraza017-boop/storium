    ...
    <div className="w-full bg-transparent min-h-screen text-[#E8E8EC] py-16">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        <div className="text-center space-y-3">
          ...
          <p className="text-sm text-[#CBD0DC] max-w-xl mx-auto">
              ...
              <div className="space-y-4 text-xs">
                ...
                <div className="flex items-start gap-3.5">
                  ...
                  <div>
                    ...
                    <span className="text-[#CBD0DC]">Gulberg III, Lahore &amp; Clifton, Karachi (Pakistan)</span>
                  </div>
                </div>
              </div>
            </div>

            <div className="p-5 rounded-2xl bg-[#0B0C0E] border border-[#262930] text-xs text-[#CBD0DC] space-y-2">
            ...
            <div className="p-8 rounded-2xl bg-[#121316] border border-[#262930] shadow-xl">
              {isSubmitted ? (
                <div className="py-16 text-center space-y-4">
                  ...
                  <div>
                    <button
                      ...
                      className="mt-4 py-2.5 px-6 rounded-xl bg-[#181A1F] text-[#D4AF37] text-xs font-semibold uppercase tracking-wider border border-[#262930] hover:bg-[#20232a] transition-colors cursor-pointer"
                    >
                ...
                <form onSubmit={handleSubmit} className="space-y-4 text-xs">
                  ...
                  <div>
                    <label htmlFor="contact-full-name" className="block text-[#CBD0DC] uppercase tracking-wider mb-1">
                      Your Full Name *
                    </label>
                    <input
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      <label htmlFor="contact-email" className="block text-[#CBD0DC] uppercase tracking-wider mb-1">
                        Email Address *
                      </label>
                      <input
                        id="contact-email"
                    ...
                    <div>
                      <label htmlFor="contact-phone" className="block text-[#CBD0DC] uppercase tracking-wider mb-1">
                        Phone / WhatsApp *
                      </label>
                      <input
                        id="contact-phone"
                  ...
                  <div>
                    <label htmlFor="contact-topic" className="block text-[#CBD0DC] uppercase tracking-wider mb-1">
                      Inquiry Topic
                    </label>
                    <select
                      id="contact-topic"
                  ...
                  <div>
                    <label htmlFor="contact-message" className="block text-[#CBD0DC] uppercase tracking-wider mb-1">
                      Message *
                    </label>
                    <textarea
                      id="contact-message"
