    ...
    return (
      <div className="py-32 text-center bg-transparent text-[#E8E8EC]">
        ...
        <button
          ...
          className="mt-4 px-6 py-2 rounded-xl bg-[#D4AF37] text-[#0B0C0E] font-bold text-xs uppercase cursor-pointer"
        >
          Return to Showroom
        </button>
      </div>
  ...
  return (
    <div className="w-full bg-transparent min-h-screen text-[#E8E8EC] py-8 sm:py-12">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav className="flex items-center gap-2 text-xs text-[#CBD0DC] mb-8 overflow-x-auto scrollbar-none" aria-label="Breadcrumb">
          <button onClick={() => navigate('home')} className="hover:text-[#F5F5F7] transition-colors cursor-pointer">
            Showroom
          </button>
          <ChevronRight className="w-3.5 h-3.5" />
          <button
            onClick={() => navigate('shop', { category: product.category })}
            className="hover:text-[#F5F5F7] transition-colors uppercase tracking-wider cursor-pointer"
          >
            ...
            <div className="space-y-4">
              ...
              {ratingSummary.count > 0 && (
                <div className="flex items-center gap-2.5">
                  ...
                  <span className="text-xs text-[#CBD0DC]">
                ...
                <div className="space-y-4 pt-3 border-t border-[#262930]">
                  {product.variants.map((v) => (
                    <div key={v.name} className="space-y-2">
                      <span className="text-xs uppercase tracking-wider text-[#CBD0DC] font-medium block">
                        Select {v.name}:
                      </span>
                        ...
                        {v.options.map((opt) => {
                          ...
                          return (
                            <button
                              ...
                              className={`px-3.5 py-2 text-xs rounded-xl border transition-all cursor-pointer ${isSelected
                                ? 'border-[#D4AF37] bg-[#D4AF37]/15 text-[#F5F5F7] font-semibold ring-1 ring-[#D4AF37]/30'
                                : 'border-[#262930] bg-[#121316] text-[#CBD0DC] hover:border-white/20'
                                }`}
                            >
                              {opt}
                            </button>
              ...
              <div className="flex items-center gap-4 pt-3">
                <span className="text-xs uppercase tracking-wider text-[#CBD0DC]">Quantity:</span>
                <div className="flex items-center rounded-xl border border-[#262930] bg-[#121316]">
                  <button
                    type="button"
                    onClick={() => setQuantity((q) => Math.max(1, q - 1))}
                    aria-label="Decrease quantity"
                    className="px-3.5 py-2 text-sm text-[#CBD0DC] hover:text-[#F5F5F7] transition-colors cursor-pointer"
                  >
                    -
                  </button>
            ...
            <div className="space-y-3 pt-6 border-t border-[#262930]">
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 py-4 px-6 rounded-xl bg-[#181A1F] hover:bg-[#22252C] text-xs sm:text-sm uppercase tracking-wider font-bold text-[#F5F5F7] border border-[#262930] hover:border-[#D4AF37]/50 shadow-md transition-all flex items-center justify-center gap-2 group cursor-pointer"
                >
                ...
                <button
                  ...
                  className={`p-4 rounded-xl border transition-all cursor-pointer ${inWishlist
              ...
              <button
                ...
                className="w-full py-4 px-6 rounded-xl bg-gradient-to-r from-[#D4AF37] via-[#E5C378] to-[#C5A059] hover:from-[#E5C378] hover:to-[#D4AF37] text-[#0B0C0E] text-xs sm:text-sm uppercase tracking-[0.2em] font-extrabold shadow-[0_10px_25px_rgba(212,175,55,0.3)] transition-all flex items-center justify-center gap-2 cursor-pointer"
              >
              ...
              {/* Value Props */}
              <div className="grid grid-cols-3 gap-3 pt-4 border-t border-[#262930] text-center text-[11px] text-[#CBD0DC]">
        ...
        <div className="py-14 border-b border-[#262930]">
          {/* Tab Navigation */}
          <div className="flex items-center gap-2.5 overflow-x-auto scrollbar-none pb-3 mb-6" role="tablist">
            <button
              type="button"
              role="tab"
            ...
            >
              ...
              <span
                className={`px-1.5 py-0.5 rounded-md text-[10px] font-mono font-bold ${activeTab === 'features' ? 'bg-[#0B0C0E]/20 text-[#0B0C0E]' : 'bg-[#181A1F] text-[#CBD0DC]'
                  }`}
              >
              ...
              {activeTab === 'specs' && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-4xl">
                  {Object.entries(product.specifications).map(([key, value]) => (
                    ...
                    >
                      <span className="text-xs uppercase tracking-wider text-[#CBD0DC] font-medium">
                        {key}
                      </span>
