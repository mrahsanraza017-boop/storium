...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="w-full bg-transparent border-t border-[#262930]/80 pb-12 text-[#8E929E]">
      {/* 4-Pillar Trust Grid */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 border-b border-[#262930]/60">
        <div className="flex flex-wrap items-center gap-2">
          <span className="text-[10px] uppercase tracking-[0.2em] text-[#626673] font-semibold mr-2 hidden sm:inline">Quick Nav:</span>
          {[
            ...
            <button
              ...
              className="btn-solid-pill-inactive flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[11px] uppercase tracking-wider"
            >
              {icon}
              <span>{label}</span>
            </button>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2 space-y-5">
            ...
            >
              <div className="relative w-11 h-11 rounded-xl overflow-hidden border border-[#D4AF37]/30 bg-[#121316] p-0.5 group-hover:border-[#D4AF37]/70 transition-all shadow-[0_0_15px_rgba(212,175,55,0.15)] flex-shrink-0">
                <img
                  src="/emblem.png"
                  alt="STORIUM Emblem"
            ...
            <div className="pt-2">
              ...
              <form onSubmit={handleSubscribe} className="flex gap-2 max-w-sm">
                ...
                <button
                  type="submit"
                  className="btn-solid-primary py-2.5 px-4 rounded-lg text-xs flex items-center justify-center gap-1"
                >
            ...
            <div className="flex flex-col gap-1.5">
              {[
                ...
                <button
                  key={label}
                  onClick={() => navigate(page)}
                  className="btn-solid-nav w-full text-left px-3 py-2 rounded-lg text-xs flex items-center justify-between group"
                >
                  <span>{label}</span>
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="mt-3 p-3 rounded-lg bg-[#0D0E10] border border-[#1E2127] space-y-2">
                <div className="flex items-center gap-2 text-[11px]">
                  ...
                  <div>
                    <span className="block text-[#626673]">Concierge Phone:</span>
                    <a href="https://wa.me/923215993022" target="_blank" rel="noreferrer" className="text-[#8E929E] font-mono hover:text-[#D4AF37] transition-colors">+92 321 5993022</a>
                  </div>
                </div>
                <div className="flex items-center gap-2 text-[11px]">
                  <ShieldCheck className="w-3 h-3 text-[#D4AF37] flex-shrink-0" />
                  <div>
                    <span className="block text-[#626673]">Support Email:</span>
                    <span className="text-[#8E929E] font-mono">concierge@storium.pk</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="flex items-center gap-2 flex-wrap justify-center">
          {[
            ...
            <button
              key={label}
              onClick={() => navigate(page)}
              className="btn-solid-utility px-3 py-1.5 rounded-md text-[11px] tracking-wide"
            >
              {label}
            </button>
          ))}
