            ...
            >
              ...
              <div className="p-5 border-b border-[#262930] flex items-center justify-between">
                ...
                <button
                  type="button"
                  onClick={closeCartDrawer}
                  className="p-2 rounded-full text-[#8E929E] hover:text-[#F5F5F7] hover:bg-[#181A1F] transition-colors"
                ...
                {cart.length === 0 ? (
                  <div className="h-full flex flex-col items-center justify-center text-center p-6 space-y-4">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-xs text-[#8E929E] max-w-xs">
                    ...
                    <button
                      ...
                      className="mt-2 py-2.5 px-5 rounded-lg bg-[#D4AF37] text-[#0B0C0E] text-xs font-bold uppercase tracking-wider hover:bg-[#E5C378] transition-all"
                    >
                      Discover Timepieces
                    </button>
                  </div>
                            ...
                            <div>
                              <div className="flex items-start justify-between gap-2">
                                ...
                                <button
                                  ...
                                  className="text-[#626673] hover:text-rose-400 transition-colors p-1"
                                  title="Remove Item"
                                >
                              ...
                              {item.selectedVariant && (
                                <p className="text-[10px] text-[#8E929E] mt-0.5">
                            ...
                            <div className="flex items-center justify-between pt-2">
                              <div className="flex items-center rounded border border-[#262930] bg-[#121316]">
                                <button
                                  ...
                                  className="px-2 py-0.5 text-xs text-[#8E929E] hover:text-[#F5F5F7]"
                                >
                                  -
                                </button>
                ...
                <div className="p-5 border-t border-[#262930] bg-[#0B0C0E]/90 space-y-3">
                  ...
                  <div className="space-y-2 pt-2">
                    <button
                      ...
                      className="w-full py-3 px-4 rounded-xl bg-gradient-to-r from-[#D4AF37] to-[#C5A059] hover:from-[#E5C378] hover:to-[#D4AF37] text-[#0B0C0E] text-xs font-bold uppercase tracking-wider shadow-lg flex items-center justify-center gap-2 transition-all"
                    >
                    ...
                    <button
                      ...
                      className="w-full py-2.5 px-4 rounded-xl bg-[#181A1F] hover:bg-[#20232A] text-[#E8E8EC] text-xs uppercase tracking-wider font-semibold border border-[#262930] transition-colors"
                    >
                      View Full Bag Details
                    </button>
                  </div>

                  <div className="flex items-center justify-center gap-2 text-[10px] text-[#626673] pt-1">
