...
export const SearchModal: React.FC = () => {
  ...
  return (
    <AnimatePresence>
      {isSearchOpen && (
        <div className="fixed inset-0 z-50 flex items-start justify-center p-4 sm:p-6 md:p-12 overflow-y-auto" role="dialog" aria-modal="true" aria-label="Search Showroom">
          {/* Backdrop */}
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            ...
            <div className="p-4 sm:p-6 border-b border-[#262930] flex items-center gap-3">
              ...
              <input
                ...
                aria-label="Search showroom timepieces and accessories"
                className="flex-1 bg-transparent text-base sm:text-lg text-[#F5F5F7] placeholder-[#8E929E] focus:outline-none tracking-wide"
              />
              {searchTerm && (
                <button
                  type="button"
                  ...
                  className="p-1.5 rounded-full text-[#8E929E] hover:text-[#F5F5F7] cursor-pointer"
                >
                  <X className="w-4 h-4" />
                </button>
              )}
              <button
                ...
                className="p-2 rounded-lg bg-[#181A1F] text-[#8E929E] hover:text-[#F5F5F7] border border-white/5 transition-colors text-xs uppercase tracking-wider cursor-pointer"
              >
                ESC
              </button>
            </div>
            ...
            <div className="px-6 py-3 bg-[#0B0C0E]/50 border-b border-[#262930] flex items-center gap-2 overflow-x-auto text-xs scrollbar-none">
              <span className="text-[#8E929E] uppercase tracking-wider text-[10px] font-semibold flex-shrink-0">
                Suggestions:
              </span>
              {quickTags.map((tag) => (
                <button
                  ...
                  className="px-2.5 py-1 rounded-md bg-[#181A1F] text-[#CBD0DC] hover:text-[#D4AF37] hover:border-[#D4AF37]/30 border border-[#262930] transition-colors flex-shrink-0 cursor-pointer"
                >
                  {tag}
                </button>
              ))}
                ...
                filtered.length > 0 ? (
                  ...
                  <div className="py-12 text-center space-y-3">
                    ...
                    <button
                      ...
                      className="mt-2 py-2 px-4 rounded-lg bg-[#181A1F] hover:bg-[#22252C] text-[#D4AF37] text-xs uppercase tracking-wider font-semibold border border-[#D4AF37]/30 transition-colors cursor-pointer"
                    >
                ...
                <div className="py-8 text-center space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 max-w-lg mx-auto">
                    <button
                      ...
                      className="p-4 rounded-xl bg-[#181A1F] hover:bg-[#20232A] border border-[#262930] hover:border-[#D4AF37]/30 text-left transition-all group cursor-pointer"
                    >
