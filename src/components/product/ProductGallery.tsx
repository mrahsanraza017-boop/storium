    ...
    <div className="flex flex-col gap-4">
      ...
      >
        <AnimatePresence mode="wait" initial={false}>
          ...
          >
            <ProductMediaFrame media={currentMedia} priority={activeIdx === 0} className="w-full h-full object-cover object-center" />
          </motion.div>
        </AnimatePresence>
        ...
        <button
          type="button"
          onClick={() => setIsLightboxOpen(true)}
          aria-label="Inspect in Fullscreen"
          className="absolute bottom-4 right-4 p-2.5 rounded-lg bg-[#0B0C0E]/80 text-[#E8E8EC] hover:text-[#D4AF37] hover:bg-[#0B0C0E] border border-white/10 backdrop-blur-md transition-all shadow-lg cursor-pointer"
        ...
        {displayMedia.length > 1 && (
          <button
            ...
            className="absolute bottom-4 left-4 p-2.5 rounded-lg bg-[#0B0C0E]/80 text-[#E8E8EC] hover:text-[#D4AF37] border border-white/10 backdrop-blur-md transition-all shadow-lg cursor-pointer"
        ...
        {displayMedia.length > 1 && (
          <>
            <button
              type="button"
              onClick={handlePrev}
              className="absolute left-3 top-1/2 -translate-y-1/2 p-2 rounded-full bg-[#0B0C0E]/70 text-[#E8E8EC] hover:text-[#D4AF37] border border-white/10 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity cursor-pointer"
            ...
            <button
              type="button"
              onClick={handleNext}
              className="absolute right-3 top-1/2 -translate-y-1/2 p-2 rounded-full bg-[#0B0C0E]/70 text-[#E8E8EC] hover:text-[#D4AF37] border border-white/10 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity cursor-pointer"
        ...
        <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-none">
          {displayMedia.map((item, idx) => (
            <button
              ...
              className={`relative flex-shrink-0 w-20 h-20 rounded-xl overflow-hidden bg-[#121316] border transition-all duration-300 cursor-pointer ${activeIdx === idx
        ...
        {isLightboxOpen && (
          ...
          >
            <button
              ...
              className="absolute top-4 right-4 sm:top-6 sm:right-6 p-3 rounded-full bg-[#181A1F]/90 text-[#E8E8EC] hover:text-[#D4AF37] border border-white/10 transition-colors z-[71] cursor-pointer"
            >
              <X className="w-6 h-6" />
            </button>
            ...
            >
              <div className="relative w-full h-full flex items-center justify-center">
                <ProductMediaFrame media={currentMedia} priority={true} className="max-h-[82vh] max-w-full w-auto h-auto object-contain rounded-xl shadow-2xl" />
                ...
                {displayMedia.length > 1 && (
                  <>
                    <button
                      ...
                      className="absolute left-2 sm:left-4 top-1/2 -translate-y-1/2 p-3 rounded-full bg-[#181A1F]/80 text-[#E8E8EC] hover:text-[#D4AF37] border border-white/10 transition-colors z-10 cursor-pointer"
                    >
                    ...
                    <button
                      ...
                      className="absolute right-2 sm:right-4 top-1/2 -translate-y-1/2 p-3 rounded-full bg-[#181A1F]/80 text-[#E8E8EC] hover:text-[#D4AF37] border border-white/10 transition-colors z-10 cursor-pointer"
                    >
