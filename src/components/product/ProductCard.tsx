  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={`absolute top-3 right-3 z-20 w-8 h-8 rounded-full flex items-center justify-center transition-all duration-300 ${inWishlist
      ...
      <div className="relative aspect-square w-full bg-[#0B0C0E] overflow-hidden">
        ...
        >
          {media.map((item) => (
            ...
            >
              <ProductMediaFrame media={item} className="h-full w-full object-cover object-center" />
            </button>
          ))}
        </div>
        ...
        >
          ...
          <button
            ...
            className={`p-2 rounded-lg border transition-all duration-300 flex items-center justify-center ${isAddedRecently
        ...
        <div>
          ...
          {ratingSummary.count > 0 && (
            <div className="mt-1.5 flex items-center gap-1.5">
              ...
              <span className="text-[10px] text-[#8E929E] tabular-nums">
