      ...
      <div className="w-full max-w-md rounded-3xl border border-[#262930]/80 bg-[#121316]/90 backdrop-blur-xl p-8 sm:p-10 shadow-2xl relative overflow-hidden">
        ...
        {(mode === 'sign-in' || mode === 'sign-up') && (
          <form onSubmit={handleSignInOrUp} className="relative z-10">
            <div className="mb-8 text-center">
              ...
              <p className="mt-2 text-xs text-[#CBD0DC] leading-relaxed">
                {mode === 'sign-in'
            ...
            <div className="space-y-4">
              {mode === 'sign-up' && (
                <div>
                  <label htmlFor="auth-full-name" className="block text-xs font-semibold uppercase tracking-wider text-[#CBD0DC] mb-1.5 flex items-center gap-1.5">
              ...
              <div>
                <label htmlFor="auth-email" className="block text-xs font-semibold uppercase tracking-wider text-[#CBD0DC] mb-1.5 flex items-center gap-1.5">
              ...
              {mode === 'sign-up' && (
                <div>
                  <label htmlFor="auth-phone" className="block text-xs font-semibold uppercase tracking-wider text-[#CBD0DC] mb-1.5 flex items-center justify-between">
                  ...
                  <p className="mt-1 text-[11px] text-[#8E929E]">
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  <label htmlFor="auth-password" className="block text-xs font-semibold uppercase tracking-wider text-[#CBD0DC] flex items-center gap-1.5">
        ...
        {mode === 'verify-phone' && (
          <form onSubmit={handleVerifyPhone} className="relative z-10 space-y-6">
            ...
            <div>
              <label htmlFor="auth-verification-code" className="block text-xs font-semibold uppercase tracking-wider text-[#CBD0DC] mb-2 text-center">
          ...
          <div className="relative z-10">
            ...
            {forgotStep === 'request' ? (
              <form onSubmit={handleForgotRequest} className="space-y-4">
                <div>
                  <label htmlFor="auth-forgot-identifier" className="block text-xs font-semibold uppercase tracking-wider text-[#CBD0DC] mb-1.5">
              ...
              <form onSubmit={handleForgotReset} className="space-y-4">
                <div>
                  <label htmlFor="auth-reset-code" className="block text-xs font-semibold uppercase tracking-wider text-[#CBD0DC] mb-1.5">
                  ...
                  <input
                    ...
                    aria-label="6-Digit Security Reset Code"
                ...
                <div>
                  <label htmlFor="auth-new-password" className="block text-xs font-semibold uppercase tracking-wider text-[#CBD0DC] mb-1.5">
                ...
                <div>
                  <label htmlFor="auth-confirm-password" className="block text-xs font-semibold uppercase tracking-wider text-[#CBD0DC] mb-1.5">
